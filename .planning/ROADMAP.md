...
- [x] 01-02-PLAN.md — PlayerHandController/View 분리와 별도 ForfeitRequested 입력 경계

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 01-03-PLAN.md — SoloScoringUIController 개명과 scene-local 포기 모달 분리

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 01-04-PLAN.md — SoloScoringGameManager 개명과 mode root 생명주기·구독 대칭

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 01-05-PLAN.md — 확장 회귀, 최종 Windows 빌드, 동일 프로세스 GUI 재검증
...
- [ ] 01-07-PLAN.md — 중단 가능한 EditMode 저장 테스트의 durable backup·stale recovery 안전 경계
...
|-------|----------------|--------|-----------|
| 1. Executable Baseline — 실행 기준선과 검증 경로 | 6/7 | In Progress|  |
